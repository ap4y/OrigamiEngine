Pod::Spec.new do |s|
  ...
  s.ios.preserve_paths    = [
      'Audio-Frameworks/bin/flac/FLAC.framework',
  ...
  s.ios.xcconfig          = { 
      'FRAMEWORK_SEARCH_PATHS' => [
          ...
          '"$(PODS_ROOT)/OrigamiEngine/Audio-Frameworks/bin/flac/"',
  ...
  s.osx.preserve_paths    = [
      'Audio-Frameworks/bin/flac/Flac_OSX/FLAC.framework',
  ...
  s.osx.xcconfig          = { 
      'FRAMEWORK_SEARCH_PATHS' => [
          '"$(SDKROOT)/Developer/Library/Frameworks"',
          '"$(DEVELOPER_LIBRARY_DIR)/Frameworks"',
          '"$(PODS_ROOT)/OrigamiEngine/Audio-Frameworks/bin/flac/FLAC_OSX"',
